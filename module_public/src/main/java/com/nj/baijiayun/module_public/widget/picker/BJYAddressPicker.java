 ...
 */
public class BJYAddressPicker extends LinkagePicker<Province, City, County> {
    ...
    public BJYAddressPicker(Context activity, ArrayList<Province> provinces) {
        super((Activity) activity, new AddressProvider(provinces));
    ...
    protected View makeCenterView() {
        ...
        countyView.setDividerConfig(null);
        countyView.setTextColor(getContext().getResources().getColor(com.nj.baijiayun.module_common.R.color.common_main_text_color_content),
                getContext().getResources().getColor(com.nj.baijiayun.module_common.R.color.common_main_text_color_title));
        cityView.setDividerConfig(null);
        cityView.setTextColor(getContext().getResources().getColor(com.nj.baijiayun.module_common.R.color.common_main_text_color_content),
                getContext().getResources().getColor(com.nj.baijiayun.module_common.R.color.common_main_text_color_title));
        provinceView.setDividerConfig(null);
        provinceView.setTextColor(getContext().getResources().getColor(com.nj.baijiayun.module_common.R.color.common_main_text_color_content),
                getContext().getResources().getColor(com.nj.baijiayun.module_common.R.color.common_main_text_color_title));
