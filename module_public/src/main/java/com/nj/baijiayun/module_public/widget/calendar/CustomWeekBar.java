...
public class CustomWeekBar extends WeekBar {
    ...
    public CustomWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.public_layout_custom_week_bar, this, true);
    ...
    private String getWeekString(int index, int weekStart) {
        String[] weeks = getContext().getResources().getStringArray(R.array.public_chinese_week_string_simple_array);
