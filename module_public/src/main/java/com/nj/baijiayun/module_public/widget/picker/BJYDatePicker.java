 ...
 * @since 2015/12/14
 */
public class BJYDatePicker extends BJYDateTimePicker {

    public BJYDatePicker(Activity activity) {
     ...
     * @see #MONTH_DAY
     */
    public BJYDatePicker(Activity activity, @DateMode int mode) {
     ...
     * 设置年月日时分的显示单位
     */
    public void setSuffix(String yearSuffix, String monthSuffix, String daySuffix) {
        super.setSuffix(yearSuffix,monthSuffix,daySuffix,"","");
    }
    ...
    @Deprecated
    @Override
    public final void setOnWheelListener(BJYDateTimePicker.OnWheelListener onWheelListener) {
    ...
    public void setOnWheelListener(final OnWheelListener listener) {
        ...
        super.setOnWheelListener(new BJYDateTimePicker.OnWheelListener() {
            @Override
