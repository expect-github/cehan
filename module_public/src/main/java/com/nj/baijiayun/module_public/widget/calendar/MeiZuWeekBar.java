...
public class MeiZuWeekBar extends WeekBar {

    private int mPreSelectedIndex;

    public MeiZuWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.public_meizu_week_bar, this, true);
    ...
    private String getWeekString(int index, int weekStart) {
        String[] weeks = getContext().getResources().getStringArray(R.array.public_chinese_week_string_array);
