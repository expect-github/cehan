...
import com.nj.baijiayun.module_course.ui.wx.courseDetail.AutoHeightViewPager;
...
public class DetailOutlineHolder extends BaseMultipleTypeViewHolder<List<Object>> {
    ...
    public DetailOutlineHolder(ViewGroup parent, Activity activity) {
        super(parent);
    ...
    @Override
    public void bindData(List<Object> model, int position, BaseRecyclerAdapter adapter) {
