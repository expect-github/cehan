...
public class EyeEditText extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.CommonEyeEditText);
        mEyeCloseDrawable = typedArray.getDrawable(R.styleable.CommonEyeEditText_common_pwd_eye_close);
        mEyeOpenDrawable = typedArray.getDrawable(R.styleable.CommonEyeEditText_common_pwd_eye_open);
