...
public class FixedTabIndicator extends LinearLayout {
    ...
    private int mTabSelectedColor = 0xFFffcc22;// 指针选中颜色
    ...
    private void init(Context context) {
        ...
        mTabDefaultColor = context.getResources().getColor(R.color.common_indicator_default);
        mTabSelectedColor = context.getResources().getColor(R.color.common_indicator_selected);
        ...
        mDividerPadding = DensityUtil.dip2px(mDividerPadding);
        drawableRight = DensityUtil.dip2px(drawableRight);
    }
    ...
    public void setmTabDefaultColor(int mTabDefaultColor) {
        this.mTabDefaultColor = mTabDefaultColor;
        postInvalidate();
    }
