...
public class MyRatingBar extends LinearLayout {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.Common_RatingBar);
        starImageSize = mTypedArray.getDimension(R.styleable.Common_RatingBar_common_starImageSize, 20);
        starPadding = mTypedArray.getDimension(R.styleable.Common_RatingBar_common_starPadding, 10);
        starStep = mTypedArray.getFloat(R.styleable.Common_RatingBar_common_starStep, 1.0f);
        stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.Common_RatingBar_common_stepSize, 1));
        starCount = mTypedArray.getInteger(R.styleable.Common_RatingBar_common_starCount, 5);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.Common_RatingBar_common_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.Common_RatingBar_common_starFill);
        starHalfDrawable = mTypedArray.getDrawable(R.styleable.Common_RatingBar_common_starHalf);
        mClickable = mTypedArray.getBoolean(R.styleable.Common_RatingBar_common_clickable, true);
        mTypedArray.recycle();
